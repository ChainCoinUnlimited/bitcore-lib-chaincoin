...
# Governance Object
A Governance Object (or "govObject") is a generic structure introduced in Chaincoin Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
####  `checkedSerialize`
Return an hexa string that can be used in chaincoind CLI
####  `serialize`
